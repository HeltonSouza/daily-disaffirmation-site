...
const Review: React.FC<ReviewProps> = ({
  ...
  return (
    <div className="bg-[rgba(255,247,220,1)] p-6 rounded-lg shadow-md">
      ...
      <p className="text-gray-600 mb-4 font-light">{content}</p>
      <div className="flex items-center">
        <div>
          <p className="text-gray-900">{author}</p>
          <p className="text-sm text-gray-500 font-light">{designation}</p>
        </div>
      </div>
    </div>
  );
